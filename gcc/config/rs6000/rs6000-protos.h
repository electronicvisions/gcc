...
extern bool easy_s2pp_hx_constant (rtx, machine_mode);
...
extern rtx gen_easy_s2pp_hx_constant (rtx);
...
extern void s2pp_hx_expand_vec_perm_le (rtx op[4]);
...
extern rtx rs6000_address_for_s2pp_hx (rtx);
